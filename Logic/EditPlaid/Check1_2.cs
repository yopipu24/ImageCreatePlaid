        ...
        public SKBitmap EditImage(SKBitmap bmp, PlaidModel model)
        {
            ...
            for (int x = 0; x < originalBmp.Width; x++)
            {
                ...
                for (int y = 0; y < originalBmp.Height; y++)
                {
                    ...
                    if (wflg1 && hflg1)
                    {
                        byte rColor = BussinessLogic.CalcColor2(model.VerticalColorRed1, model.HorizontalColorRed1);
                        byte gColor = BussinessLogic.CalcColor2(model.VerticalColorGreen1, model.HorizontalColorGreen1);
                        byte bColor = BussinessLogic.CalcColor2(model.VerticalColorBlue1, model.HorizontalColorBlue1);
                        color = new SKColor(rColor, gColor, bColor, model.Alpha);
                    }
                    else if (wflg2 && hflg2)
                    {
                        byte rColor = BussinessLogic.CalcColor2(model.VerticalColorRed2, model.HorizontalColorRed2);
                        byte gColor = BussinessLogic.CalcColor2(model.VerticalColorGreen2, model.HorizontalColorGreen2);
                        byte bColor = BussinessLogic.CalcColor2(model.VerticalColorBlue2, model.HorizontalColorBlue2);
                        color = new SKColor(rColor, gColor, bColor, model.Alpha);
                    }
                    else if (wflg1 && hflg2)
                    {
                        byte rColor = BussinessLogic.CalcColor2(model.VerticalColorRed1, model.HorizontalColorRed2);
                        byte gColor = BussinessLogic.CalcColor2(model.VerticalColorGreen1, model.HorizontalColorGreen2);
                        byte bColor = BussinessLogic.CalcColor2(model.VerticalColorBlue1, model.HorizontalColorBlue2);
                        color = new SKColor(rColor, gColor, bColor, model.Alpha);
                    }
                    else if (wflg2 && hflg1)
                    {
                        byte rColor = BussinessLogic.CalcColor2(model.VerticalColorRed2, model.HorizontalColorRed1);
                        byte gColor = BussinessLogic.CalcColor2(model.VerticalColorGreen2, model.HorizontalColorGreen1);
                        byte bColor = BussinessLogic.CalcColor2(model.VerticalColorBlue2, model.HorizontalColorBlue1);
                        color = new SKColor(rColor, gColor, bColor, model.Alpha);
                    }
                    else if (wflg1)
                    {
